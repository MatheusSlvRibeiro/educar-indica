        ...
        <footer className="bg-white text-primary">
            <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between gap-12 md:gap-0 bottom-0  py-10">
                ...
                <div className="flex flex-col gap-4 md:w-1/3">
                    ...
                    <a
                        href="https://cumedesenvolvimento.com.br/"
                        target="_blank"
                        rel="noopener noreferrer"
                    ...
                    <a
                        href="https://www.educarcomevidencias.com/politica-de-privacidade"
                        rel='noopener noreferrer'
                        target="_blank"
                        className="hover:underline text-primary font-medium"
                    >
                    ...
                    <a
                        href="https://www.educarcomevidencias.com/termos-condicoes"
                        rel='noopener noreferrer'
                        target="_blank"
                        className="hover:underline text-primary font-medium"
                    >
                    ...
                    <a
                        href="https://www.facebook.com/omundodogabs"
                        rel="noopener noreferrer"
                        target="_blank"
                        className="hover:underline text-primary font-medium"
                    >
